            ...
            VStack(alignment: .center) {
                if showIt{
                    Button("Open the Document") {
                        departmentViewModel.downloadYearBranchApp(brach: branch, year : year)
...
//struct BranchYearCSVView_Previews: PreviewProvider {
